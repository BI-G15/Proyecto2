...
# Funciones ETL
from utils.crear_tablas import crear_tablas_mujeres
...
with DAG(
    ...
    with TaskGroup('poblar_tablas') as poblar_tablas_dimensiones:
        ...
        poblar_city = PostgresOperator(
            ...
            sql=insert_query_mineria_mujeres(csv_path = "mineria")
        )
        ...
        poblar_customer = PostgresOperator(
            ...
            postgres_conn_id='postgres_localhost',
            sql=insert_query_educacion_mujeres(csv_path ="educacion")
        )
        ...
        poblar_date = PostgresOperator(
            ...
            postgres_conn_id='postgres_localhost',
            sql=insert_query_demografia_mujeres(csv_path = "poblacion")
        )
        ...
        poblar_employee = PostgresOperator(
            ...
            postgres_conn_id='postgres_localhost',
            sql=insert_query_violencia_mujeres(csv_path = "violencia")
        )
    ...
    poblar_fact_order = PostgresOperator(
            ...
            postgres_conn_id='postgres_localhost',
            sql=insert_query_municipio_mujeres(csv_path = "municipio")
    )
